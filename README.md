...
- Before the meeting:
    ...
    - Members or guests register roles, like prepared speakers, table topic masters, evaluators, etc.
...
- During the meeting:
    ...
    - Everyone votes for the best roles. The results will be collected and announced.
- After the meeting:
