        ...
        {activeTab === 'info' && (
          <form class="card editor-panel editor-info-panel" id="meeting-info-form" onSubmit={createOrSaveInfo}>
            ...
            <div class="editor-time-row">
              ...
              <div class="field"><label for="meeting-end">End</label><input id="meeting-end" type="time" value={meeting.end_time} onInput={(event) => updateMeeting('end_time', event.currentTarget.value)} /></div>
            </div>
