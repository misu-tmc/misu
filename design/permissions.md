...
- **Meeting manager**: `meeting.meeting_manager` identifies the responsible user for one
  ...
  correct attendance/actual role takers for that meeting. Site admins can do the same for
  all meetings.
...
| Edit actual role takers/attendance after check-in | meeting manager or site admin |
